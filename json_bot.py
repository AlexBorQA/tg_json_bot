...
bot = TeleBot(token='5644441126:AAEajaq2xbOyXQcCkhmMIdNQ_80eKHrRsfU', parse_mode='html') # создание бота
...
def message_handler(message: types.Message):
    try:
        ...
        bot.send_message(
            ...
            text=f'К сожалению, при обработке произошла ошибка:\n<code>{str(ex)}</code>'
        )
        # выходим из функции
        return
